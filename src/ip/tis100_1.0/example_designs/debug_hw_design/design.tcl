...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of tis100_0 slave interfaces..
	...
	connect_bd_net [get_bd_pins tis100_0/irq] [get_bd_pins axi_gpio_irq/gpio_io_i]


	# Auto assign address
	assign_bd_address

	# Copy all address to tis100_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/tis100_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_tis100_0_S00_AXI_* ]]
	puts $fp "set s00_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_tis100_0_S_AXI_INTR_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/tis100_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "tis100_v1_0_hw_${i}"
